...
function StudentCard01({
  ...
  return (
    <div className="group  p-4 px-4 bg-white rounded-md border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
